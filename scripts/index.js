...
x = setInterval(function() {
  ...
  // Display countdown if the birthday hasn't arrived
  if (distance > 0) {
    ...
    function showfireworks() {
      ...
      // Add this new part to handle the animation end and show the link
      setTimeout(onAnimationEnd, 1500 + 15000); // 1.5s delay + ~15s for the full animation cycle
    }

    init();
  }

  // Your existing animation code here (outside the main interval)
  // This code section does not need to change
  ...
  // Letter, Shard, and generateBalloonPath prototypes and functions
  // ... (Your original code for these functions remains unchanged)
  ...
  // Modified anim() function to remove the loop
  function anim() {
  ...
  // This is the new function to be called after the animation finishes
  function onAnimationEnd() {
    canvasC.style.display = 'none'; // Hide the fireworks canvas
    ...
    if (!linkContainer) {
      ...
      linkContainer.innerHTML = '<a href="https://usama-saeed-354.github.io/Happy-birthday-v5/" target="_blank" class="celebration-link">Click here to continue the celebration! 🎉</a>';
